...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    public CurrentBankAccountDTO saveCurrentBankAccount(double initialBalance, double overDraft, Long customerId) throws CustomerNotFountException {
        ...
        if (customer == null)
            throw new CustomerNotFountException("Customer not fount");
    ...
    */
    ...
    public BankAccountDTO getBankAccount(String accountId) throws BankAccountNotFountException {
        BankAccount bankAccount = bankAccountRepository.findById(accountId).orElseThrow(() -> new BankAccountNotFountException("BankAccount not fount"));
